      ...
      <div className="border-t border-border bg-card/50 backdrop-blur-sm p-2 sm:p-4 sticky bottom-0">
        <div className="max-w-4xl mx-auto flex gap-2 sm:gap-3">
          ...
          <Button
            ...
            disabled={disabled}
            className="h-[50px] sm:h-[60px] px-3 sm:px-6 bg-accent hover:bg-accent/90 flex-shrink-0"
        ...
        <p className="text-[10px] sm:text-xs text-muted-foreground text-center mt-1 sm:mt-2">
          Powered by advanced AI • <span className="hidden sm:inline">Phone icon for voice chat, Mic for voice input</span>
        </p>
      </div>
    </>
  );
